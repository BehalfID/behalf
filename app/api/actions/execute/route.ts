...
// MVP scope: only browse_web is wired up. Generalizing this gateway to
// http_request and the rest of the Enforcement Architecture roadmap is
// tracked in https://github.com/BehalfID/behalf/issues/130
