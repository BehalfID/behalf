...
const routes: Array<{
  ...
  { path: "/behalfid-vs-policylayer", changeFrequency: "monthly", priority: 0.86 },
  { path: "/behalfid-vs-cerbos", changeFrequency: "monthly", priority: 0.86 },
  { path: "/best-ai-agent-authorization", changeFrequency: "monthly", priority: 0.86 },
  ...
  { path: "/blog/authorization-is-broken-for-ai-agents", changeFrequency: "monthly", priority: 0.82 },
  { path: "/sandbox", changeFrequency: "weekly", priority: 0.85 },
  { path: "/design-partners", changeFrequency: "monthly", priority: 0.8 },
  { path: "/security", changeFrequency: "monthly", priority: 0.85 },
  { path: "/docs", changeFrequency: "weekly", priority: 0.9 },
  { path: "/docs/quickstart", changeFrequency: "weekly", priority: 0.85 },
  { path: "/docs/deploy-approvals", changeFrequency: "weekly", priority: 0.88 },
  { path: "/docs/demo-script", changeFrequency: "monthly", priority: 0.75 },
