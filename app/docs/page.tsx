...
const cards = [
  { href: "/docs/cli", title: "Coding agent quickstart (CLI/MCP)", body: "Install the behalf CLI, wire advisory MCP tools plus action-time hooks or Managed Profiles shims, and launch Claude Code, Codex, or Cursor with workspace policy active." },
  ...
  { href: "/docs/concepts", title: "Concepts", body: "Understand permission passports, fail-closed enforcement where integrated, approval-required flows, audit logs, advisory MCP tools, and Managed Profiles." },
...
export default function DocsPage() {
  return (
    <DocsShell
      ...
      description="BehalfID gates coding-agent actions where you install action-time hooks or call verify() before tools run. Block production deploys, database migrations, git pushes to main, file deletions, and billing changes — or require human approval before they execute. Advisory MCP tools provide context; they are not an interception boundary."
