...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${t("concepts")} — BehalfID`,
    description:
      "Understand permission passports, fail-closed enforcement (where integrated), approval-required flows, audit logs, advisory MCP tools, action-time hooks, and Managed Profiles.",
