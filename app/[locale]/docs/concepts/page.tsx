...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: `${t("concepts")} — BehalfID`, description: "Understand permission passports, fail-closed enforcement, approval-required flows, audit logs, MCP enforcement, and Managed Profiles.", alternates: { canonical: "/docs/concepts" } };
}
...
export default async function ConceptsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <DocsShell
      ...
      next={{ href: "/docs/troubleshooting", label: t("troubleshooting") }}
    >
