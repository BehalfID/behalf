...
const SCENES = [
  ...
  },
  {
    lines: [
      { delay: 0,    cls: "fd-line--label", text: "$ behalf verify" },
      { delay: 120,  cls: "fd-line--dim",   text: "" },
      { delay: 200,  cls: "fd-line--key",   text: "  agent    agent_openai_gpt4o" },
      { delay: 300,  cls: "fd-line--key",   text: "  action   purchase" },
      { delay: 400,  cls: "fd-line--key",   text: "  vendor   stripe.com" },
      { delay: 500,  cls: "fd-line--warn",  text: "  amount   $742.00" },
      { delay: 620,  cls: "fd-line--dim",   text: "" },
      { delay: 720,  cls: "fd-line--muted", text: "  checking passport_finance..." },
      { delay: 1100, cls: "fd-line--muted", text: "  rule: purchases ≤ $50" },
      { delay: 1400, cls: "fd-line--dim",   text: "" },
      { delay: 1500, cls: "fd-line--deny",  text: "  DECISION   denied" },
      { delay: 1620, cls: "fd-line--key",   text: "  reason     exceeds_limit" },
      { delay: 1720, cls: "fd-line--key",   text: "  executed   false" },
