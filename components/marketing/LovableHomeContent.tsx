    ...
    <>
      <section className="env-ivory relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-5 pt-20 sm:px-8 sm:pt-28 lg:pt-32">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2.5 ds-text-11 font-medium uppercase ds-tracking-0_2 text-primary">
            ...
            <p className="mt-8 max-w-lg ds-text-18 leading-relaxed text-muted-foreground">
      ...
      <Section wide className="env-stone" bleed>
        <div className="flex flex-wrap items-center gap-x-12 gap-y-4 py-14">
          <p className="ds-text-15 font-medium">Built for teams running agents in real workflows</p>
          <ul className="flex flex-wrap gap-x-10 gap-y-2 ds-text-15 text-muted-foreground">
      ...
      <section id="authority" className="dark env-charcoal text-foreground">
        <div className="mx-auto max-w-7xl px-5 py-28 sm:px-8 sm:py-36">
          <div className="flex flex-wrap items-end justify-between gap-8">
            <h2 className="display-lg ds-max-w-18ch">One path, from request to action.</h2>
            <p className="max-w-sm ds-text-16 leading-relaxed text-muted-foreground">
              Nothing an agent does skips a checkpoint. Routine work passes without friction; risk stops and waits.
            </p>
          </div>
          <SlashSeam className="my-14 ds-max-w-220" />
          <AuthorityMap />
        </div>
      </section>
      ...
      <Section wide className="env-ivory" id="adaptive">
        <Reveal className="max-w-3xl">
          <div className="flex flex-wrap items-center gap-3">
            <div className="ds-text-11 font-medium uppercase ds-tracking-0_18 text-primary">Adaptive mode</div>
            <BetaTag label="Beta" />
          </div>
          <h2 className="display-lg mt-5">Human decisions become better defaults.</h2>
          <p className="mt-6 max-w-xl ds-text-17 leading-relaxed text-muted-foreground">
          ...
          <p className="mt-5 max-w-xl ds-text-16 leading-relaxed">
        ...
        <Reveal delay={60} className="mt-20">
          <h3 className="display-lg ds-max-w-28ch ds-text-1_75rem sm:ds-text-2rem">
            Observe. Recommend. Enforce &mdash; only when a person says so.
          </h3>
          <p className="mt-5 max-w-xl ds-text-16 leading-relaxed text-muted-foreground">
      ...
      <Section wide className="env-stone">
        <Reveal className="max-w-2xl">
          <div className="ds-text-11 font-medium uppercase ds-tracking-0_18 text-primary">Evidence</div>
      ...
      <section id="product" className="env-stone">
        <div className="mx-auto max-w-7xl px-5 py-28 sm:px-8 sm:py-36">
          <p className="display-xl ds-max-w-20ch">
      ...
      <Section wide className="env-ivory">
        <div className="grid gap-12 lg:ds-grid-asymmetric-e lg:items-center lg:gap-16">
          <div className="max-w-sm">
            <div className="ds-text-11 font-medium uppercase ds-tracking-0_18 text-primary">Identity</div>
            <h2 className="display-lg mt-5">Every agent should answer for itself.</h2>
            <p className="mt-6 ds-text-17 leading-relaxed text-muted-foreground">
      ...
      <Section wide className="env-copper">
        <div className="max-w-2xl">
          <div className="ds-text-11 font-medium uppercase ds-tracking-0_18 text-primary">Permissions</div>
          <h2 className="display-lg mt-5">Authority should be explicit.</h2>
          <p className="mt-6 max-w-md ds-text-17 leading-relaxed text-muted-foreground">
      ...
      <Section wide className="env-ivory">
        <div className="max-w-2xl">
          <div className="ds-text-11 font-medium uppercase ds-tracking-0_18 text-primary">Approvals</div>
      ...
      <section className="dark env-charcoal text-foreground">
        <div className="mx-auto max-w-7xl px-5 py-28 sm:px-8 sm:py-36">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <h2 className="display-lg ds-max-w-20ch">See every action. Understand every decision.</h2>
            <Link
              href="/login"
      ...
      <section className="dark env-ink text-foreground">
        <div className="mx-auto max-w-7xl px-5 py-28 sm:px-8 sm:py-36">
          <div className="grid gap-12 lg:ds-grid-asymmetric-f lg:gap-16">
            <div className="min-w-0 max-w-sm">
              <div className="ds-text-11 font-medium uppercase ds-tracking-0_18 text-primary">Developers</div>
              <h2 className="display-lg mt-5">One decision before the action.</h2>
              <p className="mt-6 ds-text-16 leading-relaxed text-muted-foreground">
                Drop the SDK into the code path that performs the action. No proxy, no sidecar, no migration.
              </p>
              <Link
                href="/docs/quickstart"
                className="mt-7 inline-flex items-center gap-2 ds-text-15 text-primary hover:underline"
                onClick={crossAppClickHandler("/docs/quickstart")}
              >
                Read the quickstart <ArrowRight className="size-4" aria-hidden />
              </Link>
            </div>
            <div className="grid min-w-0 gap-5 xl:ds-grid-asymmetric-g">
              <CodeTabs
                tabs={[
      ...
      <Section className="env-stone">
        <div className="grid gap-10 lg:ds-grid-asymmetric-f lg:gap-16">
          <h2 className="display-lg ds-max-w-14ch">Default to no. Allow with intent.</h2>
          <dl>
            {[
