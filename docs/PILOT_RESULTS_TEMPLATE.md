...
- Follow-up scope: dashboard information architecture and permission-management UX will be handled in a separate PR. Tracked in [issue #129](https://github.com/BehalfID/behalf/issues/129).
