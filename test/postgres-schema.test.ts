...
const CRITICAL_COLUMNS: Record<string, string[]> = {
  ...
  deviceCodes: ["codeId", "deviceCode", "userCode", "status", "expiresAt"],
  agents: ["agentId", "accountId", "apiKeyHash", "status"],
  permissions: ["permissionId", "accountId", "agentId", "action", "constraints", "status"],
  permissionProfiles: ["profileId", "accountId", "name", "permissions", "status"],
  approvalRequests: ["approvalId", "requestId", "accountId", "status", "kind", "argumentFingerprint", "usedAt"],
  ...
  siteGuardKeys: ["keyId", "siteId", "accountId", "keyHash", "status"],
