...
export type BehalfIdActionType =
  | "create-permission"
  | "require-approval"
  | "block-action"
  | "enable-profile";
...
export const SEVERITY_SCORE_WEIGHTS: Readonly<Record<McpAuditSeverity, number>> = {
  critical: 30,
  high: 15,
  medium: 7,
  low: 3,
...
export const SEVERITY_RANK: Readonly<Record<McpAuditSeverity, number>> = {
  critical: 4,
  high: 3,
  medium: 2,
  low: 1,
